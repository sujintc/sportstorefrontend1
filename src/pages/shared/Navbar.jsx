...
const Navbar = () => {
    ...
    const navItems = [
        ...
        // { link: "Shop", path: "/shop" },
        { link: "Click here for Inventory", path: "/admin/dashboard" },
        // { link: "Blog", path: "/blog" },
    ];
    return (
        <header className="w-full bg-transparent fixed top-0 left-0 right-0 transition-all ease-in duration-300">
            <nav className={`py-4 lg:px-24 px-4 ${isSticky ? "sticky top-0 left-0 right-0 bg-green-300" : ""
                ...
                <div className="flex justify-between items-center text-base gap-8">
                    <Link to="/" className="text-2xl font-bold text-black-700 flex items-center gap-2"><FaBlog className="inline-block"/>Bat store</Link>
